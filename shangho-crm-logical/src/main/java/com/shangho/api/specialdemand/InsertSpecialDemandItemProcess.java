...
public class InsertSpecialDemandItemProcess extends AbstractAPIProcess {
	private InsertSpecialDemandItemRequest entity;
	private final int step = 1;

	public InsertSpecialDemandItemProcess(InsertSpecialDemandItemRequest entity) {
		this.entity = entity;
	}
	...
	protected Object process() throws SHException, Exception {
		final int ID = SpecialDemandManager.getInstance().insertItem(entity.getCategoryid(), entity.getReferid(),
	...
	protected void check() throws SHException, Exception {
		...
		if (!SpecialDemandManager.getInstance().checkItemInsertInfo(entity.getCategoryid(), entity.getReferid())) {

...
public class InsertLocationCategoryProcess extends AbstractAPIProcess {
	private InsertLocationCategoryRequest entity;
	private final int step = 1;

	public InsertLocationCategoryProcess(InsertLocationCategoryRequest entity) {
		this.entity = entity;
	}
	...
	protected Object process() throws SHException, Exception {
		final int ID = LocationManager.getInstance().insertCategory(entity.getStatus(), entity.getName(),

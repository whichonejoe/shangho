...
public class DeleteHousePatternCategoryProcess extends AbstractAPIProcess {
	private DeleteHousePatternCategoryRequest entity;
	private final int step = 1;

	public DeleteHousePatternCategoryProcess(DeleteHousePatternCategoryRequest entity) {
		this.entity = entity;
	}

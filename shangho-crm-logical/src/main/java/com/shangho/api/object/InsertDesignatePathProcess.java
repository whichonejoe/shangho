...
public class InsertDesignatePathProcess extends AbstractAPIProcess {
	private InsertDesignatePathRequest entity;
	private final int step = 1;

	public InsertDesignatePathProcess(InsertDesignatePathRequest entity) {
		this.entity = entity;
	}
	...
	protected Object process() throws SHException, Exception {
		final int ID = DesignatePathManager.getInstance().insert(entity.getStatus(), entity.getCountry(),

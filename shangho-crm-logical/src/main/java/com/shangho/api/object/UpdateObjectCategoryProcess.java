...
public class UpdateObjectCategoryProcess extends AbstractAPIProcess {
	private UpdateObjectCategoryRequest entity;
	private final int step = 1;

	public UpdateObjectCategoryProcess(UpdateObjectCategoryRequest entity) {
		this.entity = entity;
	}
	...
	protected Object process() throws SHException, Exception {
		ObjectManager.getInstance().updateCategory(entity.getId(), entity.getStatus(), entity.getType(),
